...
public class AddEditNoteActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ID = "com.example.todolist_my.view.EXTRA_ID";
    public static final String EXTRA_TITLE = "com.example.todolist_my.view.EXTRA_TITLE";
    public static final String EXTRA_SWITCH = "com.example.todolist_my.view.EXTRA_SWITCH";
    public static final String EXTRA_DATE = "com.example.todolist_my.view.EXTRA_DATE";
    public static final String EXTRA_TIME = "com.example.todolist_my.view.EXTRA_TIME";
    public static final String EXTRA_DESCRIPTION = "com.example.todolist_my.view.EXTRA_DESCRIPTION";
    public static final String EXTRA_NOTIFICATION_ID = "com.example.todolist_my.view.EXTRA_NOTIFICATION_ID";
